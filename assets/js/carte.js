...
window.PROJECTS = [
  ...
  { nom: "Caserne de Bernex", architecte: "bunq", lieu: "Bernex (GE)", lat: 46.1826254, lon: 6.0825067, url: "projets/viewer.html?p=casernebernex", glb: "projets/bunq/caserne bernex/blend.glb", categorie: "Équipement public", type: "Concours" },
  // no glb yet — the popup shows a historical photo instead when one is
  // available (photo:), otherwise falls back to a plain "à venir"
  // placeholder in the bubble (see map.js). "Nouvelles églises" studio
  // selection (Atelier Menzel & Esquivié, JMA - HEIA Fribourg SA 2026),
  // Ruhr valley reconversion candidates
  { nom: "St. Paulus", architecte: "Alfons et Florian Leitl", lieu: "Bochum (Allemagne)", lat: 51.4577264, lon: 7.2717421, url: "projets/viewer.html?p=stpaulus", categorie: "Culte", type: "Nouvelle construction" , master: true, photo: "assets/img/eglises/stpaulus.jpg" },
  { nom: "Hl. Familie (Heimkehrer Dankeskirche)", architecte: "Kurt Hubert Vieth", lieu: "Bochum-Weitmar-Mark (Allemagne)", lat: 51.4417371, lon: 7.2107848, url: "projets/viewer.html?p=hlfamilie", categorie: "Culte", type: "Nouvelle construction" , master: true, photo: "assets/img/eglises/hlfamilie.jpg" },
  ...
  { nom: "St. Antonius", architecte: "Rudolf et Maria Schwarz", lieu: "Essen-Frohnhausen (Allemagne)", lat: 51.4476571, lon: 6.9731342, url: "projets/viewer.html?p=stantonius", categorie: "Culte", type: "Reconstruction" , master: true },
  { nom: "Heilig Geist", architecte: "Emil Steffann et Gisberth Hülsman", lieu: "Mülheim an der Ruhr (Allemagne)", lat: 51.4171671, lon: 6.9042691, url: "projets/viewer.html?p=heiliggeistmuelheim", categorie: "Culte", type: "Nouvelle construction" , master: true },
  { nom: "St. Franziskus", architecte: "Ernst Burghartz", lieu: "Bottrop-Welheim (Allemagne)", lat: 51.5265128, lon: 6.9837384, url: "projets/viewer.html?p=stfranziskus", categorie: "Culte", type: "Nouvelle construction" , master: true },
  ...
  { nom: "St. Bonifatius", architecte: "Ernst von Rudloff", lieu: "Gelsenkirchen (Allemagne)", lat: 51.5555914, lon: 7.0960222, url: "projets/viewer.html?p=stbonifatius", categorie: "Culte", type: "Nouvelle construction" , master: true, photo: "assets/img/eglises/stbonifatius.jpg" },
  { nom: "Heilig Kreuz (Kulturkirche)", architecte: "Rudolf Schwarz", lieu: "Bottrop (Allemagne)", lat: 51.5251453, lon: 6.9311929, url: "projets/viewer.html?p=heiligkreuz", categorie: "Culte", type: "Nouvelle construction" , master: true, photo: "assets/img/eglises/heiligkreuz.jpg" },
